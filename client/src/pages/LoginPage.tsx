                  ...
                  <div className="space-y-4">
                    ...
                    <div className="relative">
                      ...
                      onChange={(e) => {
                        ...
                        if (email && !email.match(/^[^@]+@(gmail|yahoo)\.com$/i)) {
                        setFormError("Only Gmail or Yahoo email addresses are allowed");
                        } else {
                        setFormError(null);
                        }
                    ...
                    <div className="relative">
                      ...
                      onChange={(e) => {
                        ...
                        setFormError("Password must be at least 6 characters and contain at least one number");
                        } else {
                        setFormError(null);
                        }
